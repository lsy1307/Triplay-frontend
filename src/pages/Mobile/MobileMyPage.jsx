...
import { deleteUser } from '../../api/oauth';
const MobileMyPage = () => {
    ...
    <Container>
      <div className="content">
        ...
        <div className="info-container">
          ...
          <div className="info">
            <p className="key">아이디</p>
            <p className="value">아이디</p>
          </div>
          <div className="info">
            <p className="key">이메일</p>
            <p className="value">이메일</p>
          </div>
          <div className="info">
            <p className="key">전화번호</p>
            <p className="value">전화번호</p>
          </div>
        </div>
