                    ...
                    <DownLeftContainer>
                        <DownLeftContentContainer>
                            ...
                            <DownLeftGoToViewOtherPlanBtnWrapper>
                                <DownLeftGoToViewOtherPlanBtn>다른 여행 계획 둘러보기</DownLeftGoToViewOtherPlanBtn>
                            </DownLeftGoToViewOtherPlanBtnWrapper>
                        </DownLeftContentContainer>
                    </DownLeftContainer>
                    <DownRightContainer>
                        <DownRightImagesWrapper>
                            <PlanTripImg src="src/assets/images/planTripStartPage/plantrip1.png" alt="" />
                            <PlanTripImg src="src/assets/images/planTripStartPage/plantrip3.png" alt="" />
                            <PlanTripImg src="src/assets/images/planTripStartPage/plantrip4.png" alt="" />
                            <PlanTripImg src="src/assets/images/planTripStartPage/plantrip5.png" alt="" />
                        </DownRightImagesWrapper>
                    </DownRightContainer>
                </DownContainer>
            </TotalContainer>
...
export default PlanTripStartPage;
