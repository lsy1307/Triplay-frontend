        ...
        <Container>
            ...
            <PostGrid>
                {postData.map((post, index) => (
                    <PostCard key={index}>
                        <img src={post.src} alt={`Sample ${index + 1}`} />
                        <TextOverlay>
...
const postData = [
    ...
    },
    {
        ...
        title: "도주제주도",
        schedule: "2박 3일",
        profilePic: "../src/assets/images/profile/4FBA70D0-8065-4E65-A3FA-3D79256B83E7_1_102_o.jpeg",
        nickname: "수연수연",
        city: "제주",
        iconWho: "../src/assets/images/icons/party/family.png",
        iconTheme: "../src/assets/images/icons/theme/relax.png"
    },
    {
        ...
        title: "rudwnrudrlwkd",
        schedule: "1박 2일",
        profilePic: "../src/assets/images/profile/IMG_7478.jpeg",
        nickname: "lsy",
        city: "경주",
        iconWho: "../src/assets/images/icons/party/family.png",
        iconTheme: "../src/assets/images/icons/theme/relax.png"
